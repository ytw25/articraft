...
def main() -> None:
    ...
    assert layout.record_dataset_entry_path("rec_123") == Path("/tmp/articraft/data/records/rec_123/dataset_entry.json")
    ...
    assert layout.dataset_manifest_path() == Path("/tmp/articraft/data/cache/manifests/dataset.json")
