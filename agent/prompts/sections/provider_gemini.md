...
- `find_examples` does lexical search over curated base SDK examples. Results may be stale — adapt against current SDK docs. Entries marked `[weakly relevant]` are inspiration-only and should not be over-trusted.
