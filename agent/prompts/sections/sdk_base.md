...
- Use CadQuery only for the parts that need lower-level shape control, such as hollow shells, continuous curved forms, lofts, sweeps, boolean-cut details, or shapes that would otherwise read as placeholders.
